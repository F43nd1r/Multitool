...
var editor = albumart.getProperties().edit();
editor.setBoolean("s.labelVisibility",false).setBoolean("s.iconVisibility",false).setBoolean("i.enabled",false).setBoolean("i.onGrid",false);
editor.getBox("i.box").setColor("c","s", 0xffffffff);
editor.commit();
